...
(16, '2024_11_06_074321_add_image_to_m_user_table', 12),
(17, '2024_11_06_081726_add_image_to_m_barang_table', 13);
...
INSERT INTO `m_barang` (`barang_id`, `kategori_id`, `barang_kode`, `barang_nama`, `harga_beli`, `harga_jual`, `created_at`, `updated_at`, `image`) VALUES
...
(63, 6, 'SBK-003', 'Telur Omega (10)', 22000, 25000, '2024-10-23 02:57:50', NULL, ''),
(64, 7, 'SNK-003', 'Sari Roti', 11500, 12500, '2024-10-23 02:57:50', NULL, ''),
(65, 8, 'MND-003', 'Shampo Pantene', 17500, 18500, '2024-10-23 02:57:50', NULL, ''),
(69, 1, 'BD04', 'Tepung Es', 15000, 20000, '2024-11-06 01:24:19', '2024-11-06 01:24:19', 'OBAUL21Pnl0bq6W608XplFbyGVR3oy5jsLszp6Hc.jpg');
...
(11, 'SPR', 'Supervisor', '2024-11-05 23:25:29', '2024-11-05 23:31:19');
...
INSERT INTO `m_user` (`user_id`, `level_id`, `username`, `nama`, `password`, `avatar`, `created_at`, `updated_at`, `profile_picture`, `image`) VALUES
...
(3, 3, 'staffcaca', 'Staff/Kasir', '$2y$12$MiQqudwbKFeCPIuKuVy5oe8hDG7dhS5DMOZWcLyBPTLeYdaTDWMfS', NULL, NULL, '2024-11-06 00:14:53', NULL, ''),
(35, 1, 'admincaca', 'caca', '$2y$12$5gCdG6/MAk52SjUuCSnMou/nSnBwiGgrTITM7LVk3zGF6kylCmPB.', 'cZ9pAvRWYhDcGX2BhkRant1Hf9zLd8izY30JcYH7.jpg', '2024-10-23 02:32:21', '2024-10-23 02:41:04', NULL, ''),
(36, 2, 'penggunasatu', 'Pengguna 1', '$2y$12$NNrhmg2yTWqBOLf6gkb5bu2VzgQNaaPcwuoK07H.1QikKHhtnx2jy', NULL, '2024-11-05 22:20:31', '2024-11-05 22:20:31', NULL, ''),
(40, 2, 'penggunaempat', 'pengguna4', '$2y$12$0j5utV2pT0vdQ8UqCMDQH./Fr.foW4uGM5Mg2nVXc3QUnXA75QXnm', NULL, '2024-11-06 01:00:17', '2024-11-06 01:00:17', NULL, 'PDo38E3s3zyIv3mvXdBy95TE6UxzN7FXFTqm4d9e.jpg');
...
--
ALTER TABLE `m_barang`
  MODIFY `barang_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `m_user`
  MODIFY `user_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
